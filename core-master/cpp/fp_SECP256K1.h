...
#define MODBITS_SECP256K1 MBITS_SECP256K1
#define TBITS_SECP256K1 (MBITS_SECP256K1%BASEBITS_B256_56)              /**< Number of active bits in top word */
#define TMASK_SECP256K1 (((chunk)1<<TBITS_SECP256K1)-1)             /**< Mask for active bits in top word */
#define FEXCESS_SECP256K1 (((sign32)1<<MAXXES_SECP256K1)-1)		    /**< 2^(BASEBITS*NLEN-MODBITS) - normalised BIG can be multiplied by less than this before reduction */
